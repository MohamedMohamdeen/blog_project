    ...
    <footer class="footer-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <h6 class="widget-title">أخر الاخبار</h6>
                        @foreach($latest_posts->take(2) as $latest_post)
                        <!-- Single Blog Post -->
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="{{$latest_post->featured}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">{{$latest_post->title}}</a>
